...
public class FroggerGraphic extends JPanel implements IFroggerGraphics, KeyListener {
	private ArrayList<Element> elementsToDisplay = new ArrayList<Element>();;
	private ArrayList<Element> elementsToDisplayBonus = new ArrayList<Element>();;
	private ArrayList<Element> elementsToDisplayBackground = new ArrayList<Element>();;
	...
	public void paintComponent(Graphics g) {
		...
		Iterator<Element> i = this.elementsToDisplayBackground.iterator();
		while (i.hasNext()) {
			Element e = i.next();
			g.drawImage(e.sprite, pixelByCase * e.absc, pixelByCase * (height - e.ord - 1), this);
		}
		Iterator<Element> j = this.elementsToDisplayBonus.iterator();
		while (j.hasNext()) {
			Element e = j.next();
			g.drawImage(e.sprite, pixelByCase * e.absc, pixelByCase * (height - e.ord - 1), this);
		}
		Iterator<Element> k = this.elementsToDisplay.iterator();
		while (k.hasNext()) {
			Element e = k.next();
			g.drawImage(e.sprite, pixelByCase * e.absc, pixelByCase * (height - e.ord - 1), this);
		}
	...
	public void clear() {
		...
		this.elementsToDisplayBonus.clear();
		this.elementsToDisplayBackground.clear();
	}
	...
	public void addBonus(Element e) {
		this.elementsToDisplayBonus.add(e);
	}

	public void addBackground(Element e) {
		this.elementsToDisplayBackground.add(e);
	}
