...
public class Environment implements IEnvironment {
	 ...
	 * si forward == true, la fonction ajoutera une ligne en fin d'array et
	 * supprimera la première de l'array
	 * si forward == false, la fonction ajoutera une ligne en première place de
	 * l'array et supprimera celle en fin d'array
	 */
